    ...
    <footer className="border-t bg-card/80 backdrop-blur-md mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* О проекте */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-gradient">О проекте</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Современный учебный портал для изучения географии с интерактивными материалами, 
              тестами и практическими заданиями.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-8 h-8 rounded-full bg-primary/10 hover:bg-primary/20 flex items-center justify-center transition-colors">
          ...
          {/* Навигация */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-gradient">Навигация</h3>
          ...
          {/* Контакты */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-gradient">Контакты</h3>
          ...
          {/* Информация */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-gradient">Информация</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
